...
function buildSystemPrompt(opts: {
  ...
  const lines: string[] = [
    ...
    "- Konkrete Einzelfrage ('500 Schrauben TX25') → 1–2 items.",
    "- Kleine Wartung ('Fenster abdichten', 'Werkzeug nachbestellen') → 3–5 items.",
    "- Mittlere Aufgabe ('PSA neuer Mitarbeiter', 'Tür einbauen') → 5–7 items.",
    "- Breite Bau-Aufgabe ('Stuhl bauen', 'Trockenbau 50 m²', 'Schrank',",
    "  'Möbel') → 6–10 items, bis zu 12 erlaubt. Knausere nicht.",
    "- Bei einer Refinement-Anpassung (siehe REFINEMENT-MODUS unten) ist",
    "  die finale Anzahl typischerweise GRÖßER als der aktuelle Vorschlag,",
    "  weil der Polier oft etwas hinzufügt — niemals kleiner, außer er",
    "  sagt explizit 'entferne X'.",
    "",
